...
namespace NadekoBot.Core.Services.Impl
{
    public sealed class RedisImagesCache : IImageCache
    {
        ...
        public IReadOnlyList<byte[]> Warn => GetByteArrayData(ImageKey.Moderation_Warn);

        public IReadOnlyList<byte[]> Mute => GetByteArrayData(ImageKey.Moderation_Mute);

        public IReadOnlyList<byte[]> Ban => GetByteArrayData(ImageKey.Moderation_Ban);

        public IReadOnlyList<byte[]> Kick => GetByteArrayData(ImageKey.Moderation_Kick);
